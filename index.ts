import { collectionPrompt, floatPrompt, logo, qualityPrompt, skinPrompt } from "./src/interface/interface";
import fs from "fs";
...
async function main() {
  ...
  const afv = (desiredFloat - (answer[0].minwear))/((answer[0].maxwear) - (answer[0].minwear))
...
async function skinSelection(collection: any, itemsJson: any, quality: any): Promise<any> {
